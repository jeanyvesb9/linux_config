# zsh config file, by Jean Yves Beaucamp - 2021.
# Some parts are based on DT's .zshrc
...
alias lla='exa -la --color=always --group-directories-first'  # list all
...
# Start RainbowMiner
alias rminer='. ~/bin/RainbowMiner/start.sh'
...
# in order to prevent conda activation by defaut, and screwing with the defaut python shell
